Hyrax.config do |config|
  # Injected via `rails g hyrax:work PauwWow`
  config.register_curation_concern :pauw_wow
  # Injected via `rails g hyrax:work SaintPetersHistory`
  config.register_curation_concern :saint_peters_history
  # Injected via `rails g hyrax:work PeacockScholarship`
  config.register_curation_concern :peacock_scholarship
  # Injected via `rails g hyrax:work ThePavan`
  config.register_curation_concern :the_pavan
  # Injected via `rails g hyrax:work SaintPetersArchivalPhoto`
  # config.register_curation_concern :saint_peters_archival_photo
  # Injected via `rails g hyrax:work HistoricImageArchive`
  config.register_curation_concern :historic_image_archive
  # Injected via `rails g hyrax:work FrankJGuariniArchive`
  config.register_curation_concern :frank_j_guarini_archive
  # end
  ...
  # Path to the file characterization tool
   config.fits_path = "/fits/fits-1.0.0/fits.sh"
